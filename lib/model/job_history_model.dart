...
JobHistoryModel jobHistoryModelFromJson(String str) =>
    JobHistoryModel.fromJson(json.decode(str));

String jobHistoryModelToJson(JobHistoryModel data) =>
...
class JobHistoryModel {
  ...
  factory JobHistoryModel.fromJson(Map<String, dynamic> json) =>
      JobHistoryModel(
        ...
        data: json["data"] == null
            ? []
            : List<JobHistoryData>.from(
                json["data"]!.map((x) => JobHistoryData.fromJson(x))),
      );
...
class JobHistoryData {
  ...
  factory JobHistoryData.fromJson(Map<String, dynamic> json) => JobHistoryData(
        id: json["id"],
